          ...
          <div class="w-full px-5 sm:w-2/3 lg:w-4/12">
            ...
            <div class="mb-10 lg:mb-5 ">
              ...
              <div class="inline-flex items-center text-sky-500">
                <button
                  type="button"
                  class="w-full rounded-lg  bg-sky-600 py-2 px-4 text-center text-base font-semibold text-white shadowj transition duration-200 ease-in hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2  focus:ring-offset-sky-200 "
                >
