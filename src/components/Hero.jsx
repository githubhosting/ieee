  ...
  return (
    <>
      <section className=" text-gray-800">
        <div className="container mx-auto flex flex-col items-center px-4 pt-10 text-center  md:py-20 md:px-10 lg:px-10 ">
      ...
      >
        {images.map((image, index) => (
          <SwiperSlide key={index}>
            <img
              className="lg:h-128 h-128 w-full object-fill"
              src={image.url}
              alt={index}
              border-radius="10px"
            />
