                ...
                <table class="ml-3 min-w-full border-2">
                  <thead class="border-b border-t">
                    <tr>
                      <th
                        scope="col"
                        class="border-r px-6 py-4 text-left text-sm font-medium text-gray-900"
                      >
                        S.NO
                      </th>
                      <th
                        scope="col"
                        class="w-64 border-r px-6 py-4 text-left text-sm font-medium text-gray-900"
                      >
                        Project title
                      </th>
                      <th
                  ...
                  <tbody>
                    <tr class="border-b">
                      ...
                      <td class="whitespace-normal border-r px-6 py-4 text-sm font-light text-gray-900">
